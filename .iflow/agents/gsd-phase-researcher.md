...
```bash
node "C:/Users/muniz/Documents/GitHub/openclaude/.claude/get-shit-done/bin/gsd-tools.cjs" websearch "your query" --limit 10
```
...
@C:/Users/muniz/Documents/GitHub/openclaude/.claude/get-shit-done/references/thinking-models-research.md
...
```bash
INIT=$(node "C:/Users/muniz/Documents/GitHub/openclaude/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
```bash
node "C:/Users/muniz/Documents/GitHub/openclaude/.claude/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
...
```bash
node "C:/Users/muniz/Documents/GitHub/openclaude/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): research phase domain" --files "$PHASE_DIR/$PADDED_PHASE-RESEARCH.md"
```
