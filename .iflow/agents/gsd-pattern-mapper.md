...
when-to-use: Analyzes codebase for existing patterns and produces PATTERNS.md mapping new files to closest analogs. Read-only codebase analysis spawned by /gsd-plan-phase orchestrator before planning.
allowed-tools: 
model: inherit
inherit-tools: true
inherit-mcps: true
