---
agent-type: gsd-framework-selector
...
when-to-use: Presents an interactive decision matrix to surface the right AI/LLM framework for the user's specific use case. Produces a scored recommendation with rationale. Spawned by /gsd-ai-integration-phase and /gsd-select-framework orchestrators.
allowed-tools: 
model: inherit
inherit-tools: true
inherit-mcps: true
...
<required_reading>
Read `C:/Users/muniz/Documents/GitHub/openclaude/.claude/get-shit-done/references/ai-frameworks.md` before asking questions. This is your decision matrix.
</required_reading>
