...
when-to-use: Retroactive audit of an implemented AI phase's evaluation coverage. Checks implementation against the AI-SPEC.md evaluation plan. Scores each eval dimension as COVERED/PARTIAL/MISSING. Produces a scored EVAL-REVIEW.md with findings, gaps, and remediation guidance. Spawned by /gsd-eval-review orchestrator.
allowed-tools: 
model: inherit
inherit-tools: true
inherit-mcps: true
...
<required_reading>
Read `C:/Users/muniz/Documents/GitHub/openclaude/.claude/get-shit-done/references/ai-evals.md` before auditing. This is your scoring framework.
</required_reading>
